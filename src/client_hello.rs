...
use crate::extensions::{
    Extension, KeyShareEntry, NAMED_GROUP_SECP256R1, NAMED_GROUP_SECP384R1, NAMED_GROUP_X25519,
...
impl ClientHello {
    ...
    /// - Default cipher suites (AES-128-GCM-SHA256, AES-256-GCM-SHA384, ChaCha20-Poly1305-SHA256)
    /// - Supported versions extension (TLS 1.3)
    /// - Supported groups extension (x25519, secp256r1, secp384r1)
    /// - Signature algorithms extension (RSA-PSS, ECDSA, Ed25519)
    ...
    pub fn default_tls13(random: [u8; 32], x25519_public_key: Vec<u8>) -> Self {
        ...
        let extensions = vec![
            ...
            Extension::SignatureAlgorithms(vec![
                crate::extensions::SIG_RSA_PSS_RSAE_SHA256,
                crate::extensions::SIG_RSA_PSS_RSAE_SHA384,
                crate::extensions::SIG_RSA_PSS_RSAE_SHA512,
                crate::extensions::SIG_ECDSA_SECP256R1_SHA256,
                crate::extensions::SIG_ECDSA_SECP384R1_SHA384,
                crate::extensions::SIG_ED25519,
                crate::extensions::SIG_RSA_PKCS1_SHA256,
                crate::extensions::SIG_RSA_PKCS1_SHA384,
                crate::extensions::SIG_RSA_PKCS1_SHA512,
            ]),
